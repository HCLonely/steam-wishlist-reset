      ...
      return regeneratorRuntime.wrap(function _callee4$(_context4) {
        while (1) {
          switch (_context4.prev = _context4.next) {
            ...
            case 2:
              type = _context4.sent;
              console.log('%c%s', 'color:white;background:blue', 'type: ' + type);
              ...
              console.log('%c%s', 'color:white;background:blue', 'list: ' + JSON.stringify(list));
              _context4.next = 25;
              break;
            ...
            case 15:
              ...
              return new Promise(function (resolve) {
                ...
                reader.onerror = function (e) {
                  console.log('%c%s', 'color:white;background:blue', '读取文件失败(2)');
                  resolve(false);
                };
